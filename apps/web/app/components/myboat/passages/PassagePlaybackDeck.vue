  ...
  <UCard class="chart-surface rounded-[1.75rem] shadow-card" data-testid="passage-playback-deck">
    <template #header>
      <div class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p class="text-xs uppercase tracking-[0.22em] text-muted">Playback stage</p>
    ...
    <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(18rem,20rem)] xl:items-start">
      <div class="overflow-hidden rounded-[1.4rem] border border-default/70 bg-elevated/40">
        <MyBoatDetailedMap
          ...
          height-class="h-[22rem] sm:h-[28rem] lg:h-[32rem] xl:h-[34rem]"
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <p class="mt-2 text-sm text-muted">
            The map is showing the full route archive. Pick a passage from the rail to zoom into
            that leg, load its replay, and scrub the timeline.
          </p>
        </div>
        ...
        <template v-else-if="pending">
          ...
          <USkeleton class="h-36 rounded-[1.35rem]" />
          <USkeleton class="h-32 rounded-[1.35rem]" />
        </template>
        ...
        <template v-else>
          <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-2">
            ...
            >
              ...
              <p class="mt-2 text-xs leading-5 text-muted">{{ card.hint }}</p>
            </div>
          </div>
          ...
          <div class="rounded-[1.35rem] border border-default bg-elevated/60 p-4">
            <div class="space-y-4">
              ...
              <div
                class="inline-flex flex-wrap rounded-full border border-default/70 bg-default/80 p-1"
              >
                <UButton
          ...
          <div class="rounded-[1.35rem] border border-default bg-elevated/60 p-4">
            ...
            <div
              v-if="nearbyTraffic.length"
              class="mt-4 max-h-[16rem] space-y-3 overflow-y-auto pr-1"
            >
              <div
