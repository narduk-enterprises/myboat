            ...
            <UCard class="border-default/80 bg-default/90 shadow-card">
              ...
              <div class="space-y-3 text-sm">
                <div class="rounded-2xl border border-default bg-elevated/60 px-4 py-4">
                  ...
                  <p class="mt-2 font-medium text-default">
                    {{ detail.vessel.liveSnapshot?.statusNote || detail.vessel.liveSnapshot?.observedAt ? 'Primary vessel stream' : 'Awaiting telemetry' }}
                  </p>
                </div>
                <div class="rounded-2xl border border-default bg-elevated/60 px-4 py-4">
                  <p class="text-xs uppercase tracking-wide text-muted">Observed</p>
            ...
            <UCard class="border-default/80 bg-default/90 shadow-card">
              <template #header>
                <div>
                  ...
                  <p class="mt-1 text-sm text-muted">
                    Current vessel metrics, route-backed history, and the operational context around the latest snapshot.
                  </p>
                </div>
              </template>
              ...
              <div class="grid gap-3 md:grid-cols-2">
                ...
                <div class="rounded-2xl border border-default bg-elevated/60 px-4 py-4">
                  ...
                  <p class="mt-2 font-medium text-default">
                    {{ detail.passages.length ? `${detail.passages.length} recorded passage${detail.passages.length === 1 ? '' : 's'}` : 'No track history yet' }}
                  </p>
                  <p class="mt-1 text-xs text-muted">
                    Use the passages tab for the narrative view and this telemetry tab for live state.
                  </p>
                </div>
                <div class="rounded-2xl border border-default bg-elevated/60 px-4 py-4">
                  <p class="text-xs uppercase tracking-wide text-muted">Media-linked moments</p>
                  <p class="mt-2 font-medium text-default">
                    {{ detail.media.length }} attached
                  </p>
                  <p class="mt-1 text-xs text-muted">
              ...
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p class="mt-2 text-sm text-muted">
                    {{ installation.edgeHostname || installation.signalKUrl || 'Install details pending' }}
                  </p>
                  <p class="mt-1 text-xs text-muted">
                    {{
