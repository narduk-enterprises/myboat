    ...
    <section class="grid gap-5 lg:grid-cols-2">
      <UCard class="chart-surface rounded-[1.75rem] shadow-card">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <UButton to="/admin/users" color="neutral" variant="soft" icon="i-lucide-user-cog" class="w-full">
            Users
          </UButton>
          <UButton to="/admin/vessels" color="neutral" variant="soft" icon="i-lucide-ship" class="w-full">
            Vessels
          </UButton>
          <UButton to="/admin/installations" color="neutral" variant="soft" icon="i-lucide-cpu" class="w-full">
            Installations
          </UButton>
          <UButton to="/admin/telemetry" color="neutral" variant="soft" icon="i-lucide-broadcast" class="w-full">
            Telemetry
          </UButton>
        </div>
      </UCard>
      ...
      <UCard class="border-default/80 bg-default/90 shadow-card">
        <template #header>
          <div>
            ...
            <p class="mt-1 text-sm text-muted">
              Narrow operator actions for launch.
            </p>
          </div>
        </template>
