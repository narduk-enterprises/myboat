  ...
  await db.insert(mediaItems).values([
    {
      ...
      sourceKind: 'manual',
      sourceAssetId: null,
      sourceFingerprint: 'ui-audit:dawn-watch-change',
      matchStatus: 'attached',
      matchScore: 1,
      matchReason: 'UI audit seeded passage media.',
      isCover: true,
      lat: 29.137,
      lng: -94.682,
    ...
    },
    {
      ...
      sourceKind: 'manual',
      sourceAssetId: null,
      sourceFingerprint: 'ui-audit:squall-line-off-beam',
      matchStatus: 'attached',
      matchScore: 1,
      matchReason: 'UI audit seeded passage media.',
      isCover: true,
    ...
    },
    {
      ...
      sourceKind: 'manual',
      sourceAssetId: null,
      sourceFingerprint: 'ui-audit:harbor-entry-notes',
      matchStatus: 'attached',
      matchScore: 1,
      matchReason: 'UI audit seeded general media.',
      isCover: false,
      lat: 28.958,
      lng: -95.309,
